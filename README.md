#  Payam Resan PHP SMS API Examples

نمونه کدهای آماده PHP برای اتصال به **وب‌سرویس پیامکی پیام‌رسان**  
...
در این ریپازیتوری، **نمونه‌کدهای PHP برای استفاده از متدهای مختلف وب‌سرویس پیام‌رسان** قرار داده شده است. اگر توسعه‌دهنده PHP هستید، می‌توانید به راحتی با این کدها، سامانه پیام‌رسان را به برنامه خود متصل کنید.
